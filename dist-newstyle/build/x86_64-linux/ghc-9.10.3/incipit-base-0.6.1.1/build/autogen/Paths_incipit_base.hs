...
-- at runtime using the environment variable incipit_base_bindir.
...
-- environment variable incipit_base_libdir.
...
-- using the environment variable incipit_base_dynlibdir.
...
-- runtime using the environment variable incipit_base_datadir.
...
-- variable incipit_base_libexedir.
...
-- using the environment variable incipit_base_sysconfdir.
...
bindir     = "/home/tek/.cabal/bin"
libdir     = "/home/tek/.cabal/lib/x86_64-linux-ghc-9.10.3-126f/incipit-base-0.6.1.1-inplace"
dynlibdir  = "/home/tek/.cabal/lib/x86_64-linux-ghc-9.10.3-126f"
datadir    = "/home/tek/.cabal/share/x86_64-linux-ghc-9.10.3-126f/incipit-base-0.6.1.1"
libexecdir = "/home/tek/.cabal/libexec/x86_64-linux-ghc-9.10.3-126f/incipit-base-0.6.1.1"
sysconfdir = "/home/tek/.cabal/etc"

getBinDir     = catchIO (getEnv "incipit_base_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "incipit_base_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "incipit_base_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "incipit_base_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "incipit_base_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "incipit_base_sysconfdir") (\_ -> return sysconfdir)
